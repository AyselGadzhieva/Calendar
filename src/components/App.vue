            ...
            <FlexboxLayout flexDirection="column">
              <FlexboxLayout class="home-panel" justifyContent="space-between"
                ...
                <FlexboxLayout class="block1">
                    <Button class="btn-1" text="<<" @tap="goToLeftYear" style="font-size:26px" />
                    <Button class="btn-1" text="<" @tap="goToLeft" style="font-size:26px" />
                </FlexboxLayout>
                ...
                <FlexboxLayout class="block1">
                    <Button class="btn-1" text=">" @tap="goToRight" style="font-size:26px" />
                    <Button class="btn-1" text=">>" @tap="goToRightYear" style="font-size:26px" />
                </FlexboxLayout>
            </FlexboxLayout>
